...
type CreateReviewReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ReviewInfo    *ReviewInfo            `protobuf:"bytes,1,opt,name=reviewInfo,proto3" json:"reviewInfo,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateReviewReply) GetReviewInfo() *ReviewInfo {
	if x != nil {
		return x.ReviewInfo
	}
	return nil
...
func (x *GetReviewReply) GetReviewInfo() *ReviewInfo {
	if x != nil {
		return x.ReviewInfo
	}
	return nil
...
func (x *AppealReviewReply) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list\"v\n" +
	...
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list\"\xbc\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1a\n" +
	...
	"\tanonymous\x18\n" +
	" \x01(\bR\tanonymous\"N\n" +
	"\x11CreateReviewReply\x129\n" +
	"\n" +
	"reviewInfo\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\n" +
	"reviewInfo\"7\n" +
	"\x10GetReviewRequest\x12#\n" +
	"\breviewID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\breviewID\"K\n" +
	"\x0eGetReviewReply\x129\n" +
	"\n" +
	"reviewInfo\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\n" +
	"reviewInfo\"\xb6\x01\n" +
	"\x12AuditReviewRequest\x12#\n" +
	"\breviewID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\breviewID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12\x16\n" +
	"\x06opUser\x18\x03 \x01(\tR\x06opUser\x12\x1a\n" +
	"\bopReason\x18\x04 \x01(\tR\bopReason\x12!\n" +
	...
	"\tvideoInfo\x18\x06 \x01(\tR\tvideoInfo\"G\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status2\xc0\a\n" +
	"\x06Review\x12k\n" +
	...
	"\vAuditAppeal\x12!.api.review.v1.AuditAppealRequest\x1a\x1f.api.review.v1.AuditAppealReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/appeal/audit\x12\x8d\x01\n" +
	"\x13ListReviewByStoreID\x12).api.review.v1.ListReviewByStoreIDRequest\x1a'.api.review.v1.ListReviewByStoreIDReply\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/review/store/{storeID}\x12\x88\x01\n" +
	"\x12ListReviewByUserID\x12(.api.review.v1.ListReviewByUserIDRequest\x1a&.api.review.v1.ListReviewByUserIDReply\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/review/user/{userID}B*\n" +
	"\rapi.review.v1P\x01Z\x17review/api/review/v1;v1b\x06proto3"
...
var file_api_review_v1_review_proto_goTypes = []any{
	...
	(*ListReviewByUserIDRequest)(nil),  // 2: api.review.v1.ListReviewByUserIDRequest
	(*ListReviewByUserIDReply)(nil),    // 3: api.review.v1.ListReviewByUserIDReply
	(*ReviewInfo)(nil),                 // 4: api.review.v1.ReviewInfo
	(*CreateReviewRequest)(nil),        // 5: api.review.v1.CreateReviewRequest
	(*CreateReviewReply)(nil),          // 6: api.review.v1.CreateReviewReply
...
var file_api_review_v1_review_proto_depIdxs = []int32{
	...
	4,  // 2: api.review.v1.CreateReviewReply.reviewInfo:type_name -> api.review.v1.ReviewInfo
	4,  // 3: api.review.v1.GetReviewReply.reviewInfo:type_name -> api.review.v1.ReviewInfo
	5,  // 4: api.review.v1.Review.CreateReview:input_type -> api.review.v1.CreateReviewRequest
	...
	13, // 8: api.review.v1.Review.AppealReview:input_type -> api.review.v1.AppealReviewRequest
	...
	2,  // 11: api.review.v1.Review.ListReviewByUserID:input_type -> api.review.v1.ListReviewByUserIDRequest
	6,  // 12: api.review.v1.Review.CreateReview:output_type -> api.review.v1.CreateReviewReply
	8,  // 13: api.review.v1.Review.GetReview:output_type -> api.review.v1.GetReviewReply
	10, // 14: api.review.v1.Review.AuditReview:output_type -> api.review.v1.AuditReviewReply
	...
	3,  // 19: api.review.v1.Review.ListReviewByUserID:output_type -> api.review.v1.ListReviewByUserIDReply
