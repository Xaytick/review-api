...
func (m *CreateReviewReply) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetReviewInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateReviewReplyValidationError{
					field:  "ReviewInfo",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetReviewInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
