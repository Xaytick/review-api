...
const (
	User_Register_FullMethodName = "/api.review.v1.User/Register"
	User_Login_FullMethodName    = "/api.review.v1.User/Login"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.review.v1.User",
