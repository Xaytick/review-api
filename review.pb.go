...
const file_review_v1_review_proto_rawDesc = "" +
	"\n" +
	"\x16review/v1/review.proto\x12\rapi.review.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xbc\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1a\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status2\xa5\x05\n" +
	"\x06Review\x12k\n" +
	...
	"\vAuditAppeal\x12!.api.review.v1.AuditAppealRequest\x1a\x1f.api.review.v1.AuditAppealReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/appeal/auditB*\n" +
...
var file_review_v1_review_proto_depIdxs = []int32{
	0,  // 0: api.review.v1.CreateReviewReply.reviewInfo:type_name -> api.review.v1.ReviewInfo
	0,  // 1: api.review.v1.GetReviewReply.reviewInfo:type_name -> api.review.v1.ReviewInfo
	...
	10, // 12: api.review.v1.Review.AppealReview:output_type -> api.review.v1.AppealReviewReply
	12, // 13: api.review.v1.Review.AuditAppeal:output_type -> api.review.v1.AuditAppealReply
